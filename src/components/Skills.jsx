	...
	<div className="container flex flex-col  p-6 mx-auto  lg:flex-row lg:justify-between">
        ...
        className="flex items-center justify-center p-6  mt-8 lg:mt-0  border border-[#a5079d] lg:ml-16  rounded-lg">
            ...
            <div className='grid grid-cols-3 gap-4 '>
                ...
                <p className='content flex justify-center items-center text-3xl font-bold text-white'>HTML
                </p>
                </div>
                <div className='image'>
                <img src={CSS} alt="" className='w-32 h-32' />
                <p className='content flex justify-center items-center text-3xl font-bold text-white'>CSS</p>
                </div>
                <div className='image'>
                <img src={Tailwind} alt="" className='w-32 h-32' />
                <p className='content flex justify-center items-center text-3xl font-bold text-white text-center'>TAILWIND CSS
                </p>
                </div>
                <div className='image'>
                <img src={React} alt="" className='w-32 h-32' />
                <p className='content flex justify-center items-center text-3xl font-bold text-white text-center'>REACT JS
                </p>
                </div>
                <div className='image'>
                <img src={Js} alt="" className='w-32 h-32' />
                <p className='content flex justify-center items-center text-2xl font-bold text-white'>JAVASCRIPT
                </p>
                </div>
                <div className='image'>
                <img src={Next} alt="" className='w-32 h-32' />
                <p className='content flex justify-center items-center text-3xl font-bold text-white'>NEXT JS
                </p>
                </div>
            </div>
            </div>
        ...
        className="flex flex-col justify-center px-6 py-8 text-center  lg:text-left border border-[#a5079d] lg:mr-16 mt-8 lg:mt-0  rounded-lg">
            ...
            <div className='image'>
                ...
                <p className='content flex justify-center items-center text-3xl font-bold text-white'>NODE JS
                </p>
                </div>
            <div className='image'>
                <img src={Mongo} alt="" className='w-32 h-32' />
                <p className='content flex justify-center items-center text-3xl font-bold text-white text-center'>MONGO DB
                </p>
                </div>
            <div className='image'>
                <img src={Express} alt="" className='w-32 h-32' />
                <p className='content flex justify-center items-center text-3xl font-bold text-white text-center'>EXPRESS JS
                </p>
                </div>                              
            </div>
            </div>
